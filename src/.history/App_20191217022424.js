    ...
    <Route render={({location}) => (
      ...
      <CSSTransition classNames='fade' timeout={500} key={location.key}>
            ...
            <Route path="/palette/:paletteId/:colorId" render={routeProps => (
              <div className="page"></div><SingleColorPalette colorId={routeProps.match.params.colorId} palette={generatePalette(this.findPalette(routeProps.match.params.paletteId))} /></div>
            )} />
