  ...
  class NewPaletteForm extends Component {
      ...
      componentDidMount() {
        ...
        ValidatorForm.addValidationRule('isPaletteNameUnique', (value) => 
            this.props.palettes.every(({ paletteName }) => paletteName.toLowerCase() !== this.state.currentColor
            )
        );
    }
    state = {
        ...
        <div className={classes.root}>
          ...
          >
            <Toolbar disableGutters={!open}>
              ...
              <TextValidator value={this.state.newPaletteName} name="newPaletteName" label="Palette Name" onChange={this.handleChange} validators={["required", "isNameUnique"]} errorMessages={["this field is required", "Color name must be unique"]} />
              </ValidatorForm>
