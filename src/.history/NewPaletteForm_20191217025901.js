  ...
  class NewPaletteForm extends Component {
    ...
    addRandomColor(){
        ...
        while(isColorDuplicate){
           ...
           isColorDuplicate thistate.colors.some(color => color.name === randomColor.name)
        }
    ...
    render() {
      ...
      return (
        ...
        <PaletteFormNav open={open} palettes={palettes} handleSubmit={this.handleSubmit} handleDrawerOpen={this.handleDrawerOpen} />
          ...
          >
            <div className={classes.drawerHeader} />
                <DraggableColorList axis="xy" colors={colors} removeColor={this.removeColor} distance={10} onSortEnd={this.onSortEnd} />
          </main>
        </div>
      );
    }
